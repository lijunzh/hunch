...
fn min_pass_rate(path: &str) -> f64 {
    match path {
        ...
        "tests/fixtures/rules/video_codec.yml" => 89.0,
        "tests/fixtures/rules/audio_codec.yml" => 86.0,
        "tests/fixtures/rules/release_group.yml" => 78.0,
        ...
        "tests/fixtures/rules/episodes.yml" => 49.0,
        ...
        "tests/fixtures/movies.yml" => 55.0,
        "tests/fixtures/episodes.yml" => 48.0,
        "tests/fixtures/various.yml" => 41.0,
        _ => 0.0,
    }
}
