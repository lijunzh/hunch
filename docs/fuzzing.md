...
| **Coverage** (#168) | Which lines are exercised at all | [`docs/coverage.md`](./coverage.md) |
| **Mutation testing** (#146) | Whether assertions actually catch bugs | [`docs/mutation-baseline.md`](./mutation-baseline.md) |
...
[`.github/workflows/fuzz.yml`](../.github/workflows/fuzz.yml) defines two jobs:
...
- [SECURITY.md](../SECURITY.md) — fuzzing maps to "DoS via crafted
  filenames" in the threat model
- Sibling docs: [`coverage.md`](./coverage.md),
  [`mutation-baseline.md`](./mutation-baseline.md),
